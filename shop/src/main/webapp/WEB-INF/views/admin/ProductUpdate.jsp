		     ...
		     <table class="tableclass3">
				...
				<tbody style="height: 90%;">
					<tr> 
						...
						<td class="tbodystyle"><input type="text" name="name" size="20" value="${idto.item_name}"></td>
					</tr>
					<tr> 
						<td class="tbodystyle">상품가격</td>
						<td class="tbodystyle"><input type="text" name="price" size="20"  value="${idto.item_first_price}">원</td>
					</tr>
					<tr> 
						<td class="tbodystyle">상품설명</td>
						<td class="tbodystyle"><textarea rows="10" cols="80" name="detail" >${idto.item_descripttion}</textarea></td>
					</tr>
					<tr> 
						<td class="tbodystyle">상품수량</td>
						<td class="tbodystyle"><input type="text" name="stock" size="10" value="${idto.item_stock}">개</td>
					</tr>
					<tr> 
						<td class="tbodystyle">상품이미지</td>
						<td class="tbodystyle"><img src="/img/thumbnail/${idto.item_thumbnail}" height="150" width="150"><input type="file" name="image2"  SIZE ="30" style="height: 25PX"></td>
					</tr>
					<tr > 
