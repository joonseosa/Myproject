...
public class ProjectController {
	...
	public String loginCheck(@RequestParam String memId,@RequestParam String memPw,Model model,HttpSession session,HttpServletResponse response)throws IOException {
