				   	    ...
				   	    <table>
				 			...
				 			<tr>
						      <td class="tbodystyle">ID</td>
							   <td class="tbodystyle"><input type="text"  name="admin_id" id="id" size=30></td>
							</tr>
							<tr> 
							<td class="tbodystyle"> Password</td>
							<td class="tbodystyle"><input type="password" name="admin_passwd" id="password" size=30></td>
							</tr>
							<tr class="theadstyle"> 
							  <td class="tbtnstyle" colspan="2"><button id='login'>로그인</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
