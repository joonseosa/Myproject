...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception{
        ...
        // 상품정보
        Book book = createBook("명준 JPA", 60000, 10);
        ...
        assertEquals("주문 가격은 가격 * 수량이다",60000 * orderCount,getOrder.getTotalPrice());
        assertEquals("주문 수량만큼 재고가 줄어야한다",8,book.getStockQuantity());
    }
        // 사용한 단축키  ctr + alt + m  메소드 만들기  , ctr+alt+p  파라미터 꺼내기
    ...
    public void 상품주문_재고수량초과() throws Exception{
        //given
        Member member=createMember();
        Item item =createBook("명준 JPA", 60000, 10);
    ...
    public void 주문취소() throws Exception{
        ...
        //given
        Member member = createMember();
        Book item = createBook("명준JPA",10000,10);
