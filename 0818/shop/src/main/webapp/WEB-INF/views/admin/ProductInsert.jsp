		     ...
		     <table class="tableclass3">
				...
				<tbody style="height: 90%;">
					<tr> 
						...
						<td class="tbodystyle"><input type="text" name="item_no" size="20"></td>
					</tr>
					<tr> 
						<td class="tbodystyle">상품원가</td>
						<td class="tbodystyle"><input type="text" name="item_first_price" size="20">원</td>
					</tr>
					...
					<tr> 
						...
						<td class="tbodystyle"><input type="text" name="item_name" size="20"></td>
					</tr>
					<tr> 
						<td class="tbodystyle">재고</td>
						<td class="tbodystyle"><input type="text" name="item_stock" size="10">개</td>
					</tr>
					<tr> 
						<td class="tbodystyle">이미지첨부 </td>
						<td class="tbodystyle"><input type="file" name="item_thumbnail2"  SIZE = "30" style="height: 25PX"></td>
					</tr>
					<tr > 
