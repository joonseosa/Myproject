...
<body>
 ...
 <c:import url="Top.jsp"/>
  ...
  <table class="tb">
	  <tr> 
	   <td  class="tb2">
		<form method="post" action="productMgrProc?flag=insert" enctype="multipart/form-data">
		     <table class="tableclass3">
				...
				<tbody style="height: 90%;">
					<tr> 
						...
						<td class="tbodystyle"><input type="text" name="name" size="20"></td>
					</tr>
					<tr> 
						<td class="tbodystyle">상품가격</td>
						<td class="tbodystyle"><input type="text" name="price" size="20">원</td>
					</tr>
					<tr> 
						<td class="tbodystyle">상품설명</td>
						<td class="tbodystyle"><textarea rows="10" cols="80" name="detail"></textarea></td>
					</tr>
					<tr> 
						<td class="tbodystyle">상품수량</td>
						<td class="tbodystyle"><input type="text" name="stock" size="10">개</td>
					</tr>
					<tr> 
						<td class="tbodystyle">상품이미지</td>
						<td class="tbodystyle"><input type="file" name="image2"  SIZE = "30" style="height: 25PX"></td>
					</tr>
					<tr > 
