			...
			<div class="row">
				<div class="col-lg-12 col-sm-12">
					<div class="contact-form-right">
						...
						<input type="hidden" name="item_no" value="${iqdto.item_no}">
						<input type="hidden" name="inq_ref" value="${iqdto.inq_no}">
							<div class="row">
								<div class="col-md-12">
								...
								<div class="col-md-12">
									<div class="form-group">
										<input type="text" class="form-control" id="subject"
											name="inq_title" placeholder="제목" required data-error="제목을 입력하세요">
										<div class="help-block with-errors"></div>
									</div>
								</div>
								<div class="col-md-12">
