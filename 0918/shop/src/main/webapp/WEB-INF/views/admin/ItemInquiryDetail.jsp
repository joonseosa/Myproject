...
<script type="text/javascript">
	$(function(){
		$("#deleteBtn").click(function(){
			if(confirm("삭제하시겠습니까?")){
				window.location.href="/ItemInquiryDelete?inq_no=${iqdto.inq_no}";
			}else{
				return false;
			}
		});
...
<%-- 				<img src="/img/thumbnail/${idto.item_thumbnail}" height="150" width="150"> --%>
			  ...
			  <td class="tbodystyle" width="30%" >
				...
				<tr>
				<td class="tbodystyle" ><b>상품문의 분류  : </b>${iqdto.question_no}</td>
				</tr>
...
<%-- 			<a href="javascript:productUpdate('${pdto.no}','D')">삭제하기</a>&nbsp;&nbsp;&nbsp;&nbsp; --%>
			<a href="/ItemInquiryWrite?inq_no=${iqdto.inq_no}&item_no=${iqdto.item_no}">답글</a>
