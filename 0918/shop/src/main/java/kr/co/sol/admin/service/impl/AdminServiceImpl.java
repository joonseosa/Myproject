...
//	}
	...
	System.out.println("ocdto 확인 : "+ocdto.toString());
	int r = adminDao.OrderCancelUpdate(ocdto);
	System.out.println("결과 확인1 :"+ r);
	int r2 = adminDao.orderCancelStatus(ocdto);
	System.out.println("결과 확인2 :"+ r);
	}
	...
	//MD추천상품
	@Override
	public List<MdItemDTO> getMdItem(MdItemDTO midto) {
		// TODO Auto-generated method stub
		return adminDao.getMdItem(midto);
	}

	@Override
	public void MdItemInsert(MdItemDTO midto) {
		// TODO Auto-generated method stub
		 adminDao.MdItemInsert(midto);
	}

	@Override
	public int MdItemSelect(String item_no) {
		// TODO Auto-generated method stub
		return adminDao.MdItemSelect(item_no);
	}
	@Override
	public int MdItemDelete(MdItemDTO midto) {
		// TODO Auto-generated method stub
		return adminDao.MdItemDelete(midto);
	}

	//매출조회
		@Override
		public List<PayMoneyDTO> getPayMoney(PayMoneyDTO pmdto){
			return adminDao.getPayMoney(pmdto);
		}
